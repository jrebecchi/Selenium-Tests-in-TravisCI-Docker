[![Build Status](https://travis-ci.org/jrebecchi/Selenium-Tests-in-TravisCI-Docker.svg?branch=master)](https://travis-ci.org/jrebecchi/Selenium-Tests-in-TravisCI-Docker)
